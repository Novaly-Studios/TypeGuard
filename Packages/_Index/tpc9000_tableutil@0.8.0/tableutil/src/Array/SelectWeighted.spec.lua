    ...
    describe("Array/SelectWeighted", function()
        ...
        it("should select the same weighted value with a seed", function()
            ...
            for _ = 1, 100000 do
                ...
                if (Last) then
                    expect(Temp.ID).to.equal(Last.ID)
                end
        ...
        it("should produce distributions similar to the weights", function()
            ...
            expect(Results.P).to.be.near(100000 * 0.1, 100000 * 0.1 * 0.1)
            expect(Results.Q).to.be.near(100000 * 0.1, 100000 * 0.1 * 0.1)
            expect(Results.R).to.be.near(100000 * 0.3, 100000 * 0.3 * 0.1)
            expect(Results.S).to.be.near(100000 * 0.05, 100000 * 0.05 * 0.1)
            expect(Results.T).to.be.near(100000 * 0.05, 100000 * 0.05 * 0.1)
            expect(Results.U).to.be.near(100000 * 0.15, 100000 * 0.15 * 0.1)
            expect(Results.V).to.be.near(100000 * 0.25, 100000 * 0.25 * 0.1)
        end)
    end)
end