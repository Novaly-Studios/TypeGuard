return function()
    ...
    describe("Map/Map", function()
        ...
        it("should return the same table if values are the same and the table is frozen", function()
            local Base = table.freeze({A = 1, B = 2})
        ...
        it("should return a copy of the original table if values are the same and the table is not frozen", function()
            local Base = {A = 1, B = 2}
            local Result = Map(Base, function(Value)
                return Value
            end)
